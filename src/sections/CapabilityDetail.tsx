  ...
  if (!data) {
    return (
      <div style={{ background: '#060D1A', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <p style={{ color: '#A8B8CC', fontFamily: "'Inter', sans-serif" }}>{capabilityDetailConfig.notFoundText || 'Not found.'}</p>
      </div>
    );
  }
    ...
    <div style={{ background: '#060D1A', minHeight: '100vh', position: 'relative', overflowX: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 5vw' }}>
          <div style={{ width: '100%', height: 1, background: 'rgba(0,180,216,0.08)' }} />
        </div>
